...
entry:
  ...
  %call11 = call i32 @collatz.1(i16* %iter, i32 %conv, i32* %gv0)
...
; Function Attrs: nounwind ssp uwtable
define i32 @collatz.1(i16* %iter, i32 %n, i32* %gv0) #1 {
entry:
  %conv = zext i32 %n to i64
  call void @write(i64 %conv)
  %cmp = icmp ule i32 %n, 1
  store i32 10, i32* %gv0, align 4
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call1 = call i32 @collatz.1(i16* %iter, i32 %cond, i32* %gv0)
  br label %return

return:                                           ; preds = %cond.end, %if.then5, %if.then
  %retval.0 = phi i32 [ %n, %if.then ], [ -1, %if.then5 ], [ %call1, %cond.end ]
  ret i32 %retval.0
}

attributes #0 = { "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="penryn" "target-features"="+cx16,+cx8,+fxsr,+mmx,+sahf,+sse,+sse2,+sse3,+sse4.1,+ssse3,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
