...
.while.body.i.preheader:
  ...
  r8 = mul r4 1 64 
  r9 = mul r4 1 64 
  br r1 .while.body.i.prol.loopexit .while.body.i.prol 
.while.body.i.prol:
  r2 = load 4 r8 0 
  r1 = load 4 r9 0 
  r1 = icmp slt r2 r1 32 
...
.for.body39.lr.ph:
  r1 = mul r12 4294967296 64 
  r11 = sdiv r1 4294967296 64 
  r1 = sub r14 r15 64 
  r10 = urem r1 4611686018427387904 64 
  r1 = add r1 1 64 
  r16 = mul r3 1 32 
  r3 = mul r13 1 64 
  r13 = mul r3 1 32 
...
.while.body.i.i17.preheader:
  ...
  r8 = mul r3 1 64 
  r1 = mul r3 1 64 
  br r2 .while.body.i.i17.prol.loopexit .while.body.i.i17.prol 
...
.min_at_row.exit22:
  ...
  r1 = select r1 r13 r2 
  r4 = icmp eq r12 r11 64 
  r2 = mul r1 1 32 
  r3 = mul r12 1 64 
  r13 = mul r1 1 32 
  br r4 .for.cond.cleanup38 .for.body39 
.while.end:
  sp = add sp 24 64 
  ret 0 
end main
