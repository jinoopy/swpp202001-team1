...
entry:
  ...
  %conv1 = shl i64 %mul, 3
  %mul2 = and i64 %conv1, 34359738360
  %call3 = call noalias i8* @malloc(i64 %mul2) #5
  %0 = bitcast i8* %call3 to i64*
  %mul4 = mul i64 %call, %call
  %conv5 = shl i64 %mul4, 3
  %mul6 = and i64 %conv5, 34359738360
  %call7 = call noalias i8* @malloc(i64 %mul6) #5
  %1 = bitcast i8* %call7 to i64*
  %mul8 = mul i64 %call, %call
  %conv9 = shl i64 %mul8, 3
  %mul10 = and i64 %conv9, 34359738360
