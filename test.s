...
.while.body:
  ...
  r1 = call read 
  r3 = load 4 r5 0 
  r4 = icmp eq r5 r11 64 
  r1 = mul r3 1 32 
  br r4 .min_element.exit .while.body.i.preheader 
...
.while.body.i.prol:
  r1 = icmp slt r8 r7 32 
  r4 = select r1 r8 r7 32 
  r2 = add r2 18446744073709551615 64 
  r1 = icmp eq r2 0 64 
  r5 = mul r4 1 32 
